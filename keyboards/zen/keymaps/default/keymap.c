...
[_QWERTY] = KEYMAP( \
  ...
  KC_LSFT,          KC_Z,    KC_X,    KC_C,    XXXXXXX,   KC_B,                       KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_ENT , \
  KC_LCTL,          KC_LGUI, KC_LALT, RGB_TOG, KC_V,     KC_SPC,  KC_DEL,  KC_ENT,   KC_SPACE, MO(_NAV), KC_MINS, KC_EQL,  KC_PGUP, KC_PGDN \
),
