...
#define LANG LT(L_RAISE, TD(TD_LANG))
#define JA_ZKHK LT(L_RAISE, LALT(KC_GRV)) // 全角半角
#define ML_CLON LT(L_LOWER, JA_CLON)
...
[L_QWERTY] = KEYMAP( \
  ...
  TD(TD_LANG),KC_A,    KC_S,    KC_D,     KC_F,    KC_G,                    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, ML_CLON,          \
 ...
 */
[L_LOWER] = KEYMAP( \
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    XXXXXXX, XXXXXXX, JA_LBRC, JA_RBRC, JA_HAT,  JA_ENVL, \
...
[L_RAISE] = KEYMAP( \
  ...
  _______, KC_WH_L, KC_WH_R, XXXXXXX, KC_MS_U, KC_WH_D,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
