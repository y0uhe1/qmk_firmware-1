...
[_LAYER1] = LAYOUT( \
  KC_ESC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MINS,       RSFT(KC_MINS), KC_EQL,        RSFT(KC_INT3), KC_DEL, \
  KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RSFT(KC_RBRC), KC_QUOT,       KC_LBRC,       RSFT(KC_LBRC), XXXXXXX, \
  KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, XXXXXXX, RSFT(KC_BSLS), RSFT(KC_SCLN), RSFT(KC_QUOT), RSFT(KC_INT1),   XXXXXXX, \
